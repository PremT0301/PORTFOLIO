          ...
          {publications.map((pub, index) => (
            ...
            >
              <div className="flex flex-col md:flex-row md:items-start md:justify-between">
                ...
                <button className="mt-4 md:mt-0 md:ml-4 p-3 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors duration-200 flex items-center space-x-2 text-blue-600 dark:text-cyan-400 font-medium">
